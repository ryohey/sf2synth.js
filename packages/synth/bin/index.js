...
var SoundFont_1 = bin.SoundFont = SoundFont;
bin.convertTime = convertTime;
bin.createGeneraterObject = createGeneraterObject;
bin.defaultInstrumentZone = defaultInstrumentZone;
bin.getInstrumentGenerators = getInstrumentGenerators;
bin.getInstrumentZone = getInstrumentZone;
bin.getInstrumentZoneIndexes = getInstrumentZoneIndexes;
bin.getPresetGenerators = getPresetGenerators;
...
class Synthesizer {
    ...
    loadSoundFont(input) {
        const parser = parse_1(input);
        this.soundFont = new SoundFont_1(parser);
    }
    connect(destination) {
